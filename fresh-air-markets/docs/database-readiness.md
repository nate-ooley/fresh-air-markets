...
- All twenty-two numbered migrations are present in order.
...
wrapper handling, all twenty-two migration files, checksum/order enforcement and
...
complete 001–022 migration sequence beside the preserved demo. Run this suite
