    ...
    <main className="min-h-screen bg-cream px-6 py-10">
      <div className="mx-auto max-w-4xl">
        <div className="flex items-center justify-between">
          ...
          <nav className="flex gap-4 text-sm text-pine-deep"><Link href="/applications" className="underline">Applications</Link><Link href="/roster" className="underline">Roster</Link><Link href="/staff" className="underline">Staff</Link></nav>
        </div>
