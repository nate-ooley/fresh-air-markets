...
import { FULL_SEASON_LABEL, MAX_BOOTHS_PER_APPLICATION, VENDOR_CATEGORIES } from "@/lib/portal-intake";
  ...
  return (
    <div className="bg-cream text-ink">
      ...
      <main className="mx-auto max-w-3xl px-5 py-12 sm:py-16">
        ...
        <div className="mt-8">
          <ApplyForm dates={[...FRESH_AIR_SEASON_DATES]} categories={VENDOR_CATEGORIES} fullSeasonLabel={FULL_SEASON_LABEL} maxBooths={MAX_BOOTHS_PER_APPLICATION} />
        </div>
      </main>
      <SiteFooter />
    </div>
